 ...
 *
 * For example: `<f:render.character ascii="10" /> renders a UNIX linebreak
 * as does {f:render.character(ascii: 10)}. Can be used in combination with
 * `f:`iterator.loop` to render sequences or repeat the same character:
 *
 *     {f:generate.ascii(ascii: 10) -> f:iterator.loop(count: 5)}
 *
