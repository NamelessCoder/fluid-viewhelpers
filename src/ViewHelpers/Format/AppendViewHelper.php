 ...
 *     {text -> f:format.eliminate(strings: 'foo,bar')
 *           -> f:format.append(add: ' - my foo and bar are the only ones in this text.')
 *           -> f:format.html()}
 ...
 *     <f:format.append add="{f:translate(key: 're')}">{subject}</v:format.append>
