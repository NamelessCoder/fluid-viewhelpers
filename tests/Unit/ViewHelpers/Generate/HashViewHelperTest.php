...
class HashViewHelperTest extends AbstractViewHelperTestCase
{
    ...
    {
        $test = $this->executeViewHelperUsingTagContent(['algorithm' => 'md5'], [], 'please hash me');
    ...
    {
        $test = $this->executeViewHelperUsingTagContent(['algorithm' => 'sha1'], [], 'please hash me');
    ...
    {
        $test = $this->executeViewHelperUsingTagContent(['algorithm' => 'sha256'], [], 'please hash me');
